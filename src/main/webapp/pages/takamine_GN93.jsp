<%-- 
    Document   : takamine_GN93
    Created on : 3/08/2025, 13:32:54
    Author     : Kevin
--%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Takamine GN93 | Tienda en Línea</title>
    ...
    <body>
        ...
        <section class="producto-container">
            <div class="producto-imagen">
                <img src="../image/takamine_GN93.jpg" alt="Guitarra acústica Takamine GN93">
            </div>
            <div class="producto-detalles">
                <div>
                    <%
                        ProductoDAO productoDAO = new ProductoDAO();
                        Producto producto = productoDAO.getProductoById(4);
                        int stock = 0;
                        stock = producto.getStock();
                    %>
                    <h1>Takamine GN93</h1>
                    <p class="descripcion">Guitarra acústica con fondo de nogal y aros de arce</p>
                    <p class="proveedor">Proveedor: Takamine</p>
                    <p class="categoria">Categoría: Guitarras Acústicas</p>
                    <p class="precio">Q.3100.00</p>
