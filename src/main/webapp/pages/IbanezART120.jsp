<%-- 
    Document   : IbanezART120
    Created on : 3/08/2025, 11:31:13
    Author     : Emilio
--%>
...
<head>
    <meta charset="UTF-8">
    <title>Ibanez ART120 | Tienda en Línea</title>
...
<body>
    ...
    <section class="producto-container">
        <div class="producto-imagen">
            <img src="../image/IbanezART120.jpg" alt="Ibanez ART120">
        </div>
        <div class="producto-detalles">
            <div>
                <h1>Ibanez ART120</h1>
                <p class="descripcion">Estilo single cutaway con humbuckers</p>
                <p class="proveedor">Proveedor: Ibanez</p>
                <p class="categoria">Categoría: Guitarras</p>
                <p class="precio">Q. 3,500.00</p>
