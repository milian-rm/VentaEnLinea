<%-- 
    ...
    Created on : 29/07/2025, 08:26:13
    Author     : informatica
--%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Editar Proveedor - GuitarKinal</title>
    ...
    <body>
        ...
        <%-- Contenido Principal: Formulario de Editar Proveedor --%>
        <main class="container mt-5">
            <div class="row justify-content-center">
                <div class="col-md-6 col-lg-5">
                    <h1 class="mb-4 text-center">Editar Proveedor</h1>
                    <%-- El formulario enviará los datos al ServletProveedor para actualizar el proveedor --%>
                    <%
                    Proveedor pro = (Proveedor) request.getAttribute("listaProveedor");
                    %>
                    
                    <form action="<%= request.getContextPath() %>/ProveedorServlet" method="post">
                        <input type="hidden" name="accion" value="actualizar">
                        <input type="hidden" name="idProveedor" value="<%= pro.getIdProveedor() %>">
