<%-- 
    Document   : estucherigidoelectrica
    Created on : 2/08/2025, 23:28:32
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Estuche rígido para eléctrica | Tienda en Línea</title>
    ...
    <body>
        ...
        <div class="container mt-4">
            <a href="../pages/accesorios.jsp"><button class="btn btn-regresar">Regresar al menú</button></a>
        </div>

        <section class="producto-container">
            <div class="producto-imagen">
                <img src="../image/fundafender.jpg" alt="Estuche rígido para eléctrica">
            </div>
            <div class="producto-detalles">
                <div>
                    <%
                        ProductoDAO productoDAO = new ProductoDAO();
                        Producto producto = productoDAO.getProductoById(25);
                        int stock = 0;
                        stock = producto.getStock();
                    %>
                    <h1>Estuche rígido para eléctrica</h1>
                    <p class="descripcion">Protección segura para transporte</p>
                    <p class="proveedor">Proveedor: Fender</p>
                    <p class="categoria">Categoría: Accesorios</p>
                    <p class="precio">Q.1100.00</p>
                ...
                <form class="compra-form" action="${pageContext.request.contextPath}/ServletCarrito" method="post">
                    ...
                    <input type="hidden" name="idProducto" value="25">
