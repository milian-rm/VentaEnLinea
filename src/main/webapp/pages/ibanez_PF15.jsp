<%-- 
    Document   : ibanez_PF15
    Created on : 3/08/2025, 13:36:41
    Author     : Kevin
--%>
...
<head>
    <meta charset="UTF-8">
    <title>Ibanez PF15 | Tienda en Línea</title>
...
<body>
    ...
    <section class="producto-container">
        <div class="producto-imagen">
            <img src="../image/ibanez_PF15.jpg" alt="Guitarra acústica Ibanez PF15">
        </div>
        <div class="producto-detalles">
            <div>
                <h1>Ibanez PF15</h1>
                <p class="descripcion">Guitarra acústica económica ideal para principiantes</p>
                <p class="proveedor">Proveedor: Ibanez</p>
                <p class="categoria">Categoría: Guitarras Acústicas</p>
                <p class="precio">Q.1800.00</p>
                <p class="stock">Stock disponible: 14 unidades</p>
            </div>

            <form class="compra-form">
                <label for="cantidad">Cantidad:</label>
                <input type="number" id="cantidad" name="cantidad" min="1" max="14" value="1">
