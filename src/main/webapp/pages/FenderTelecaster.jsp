<%-- 
    Document   : FenderStratocaster
    Created on : 3/08/2025, 11:30:39
    Author     : Emilio
--%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Fender Telecaster | Tienda en Línea</title>
    ...
    <body>
        ...
        <section class="producto-container">
            <div class="producto-imagen">
                <img src="../image/FenderTelecaster.png" alt="Fender Telecaster">
            </div>
            <div class="producto-detalles">
                <div>
                    ...
                    <p class="descripcion">Cuerpo de fresno y pastillas single coil</p>
                    <p class="proveedor">Proveedor: Fender</p>
                    <p class="categoria">Categoría: Guitarras</p>
                    <p class="precio">Q. 4,700.00</p>
