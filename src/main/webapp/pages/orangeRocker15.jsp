<%-- 
    Document   : orangeRocker15
    Created on : 3 ago 2025, 8:48:40
    Author     : Marcos
--%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Orange Rocker 15 | Tienda en Línea</title>
    ...
    <body>
        ...
        <section class="producto-container">
            <div class="producto-imagen">
                <img src="../image/Orange Rocker 15.png" alt="Orange Rocker 15">
            </div>
            <div class="producto-detalles">
                <div>
                    <%
                        ProductoDAO productoDAO = new ProductoDAO();
                        Producto producto = productoDAO.getProductoById(19);
                        int stock = 0;
                        stock = producto.getStock();
                    %>
                    <h1>Orange Rocker 15</h1>
                    <p class="descripcion">Combo de 15W todo válvulas</p>
                    <p class="proveedor">Proveedor: Orange</p>
                    <p class="categoria">Categoría: Amplificadores</p>
                    <p class="precio">Q.6,200.00</p>
                ...
                <form class="compra-form" action="${pageContext.request.contextPath}/ServletCarrito" method="post">
                    ...
                    <input type="hidden" name="idProducto" value="19">
