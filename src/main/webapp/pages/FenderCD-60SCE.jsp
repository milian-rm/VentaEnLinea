...
<head>
    <meta charset="UTF-8">
    <title>Fender CD-60SCE | Tienda en Línea</title>
...
<body>
    ...
    <section class="producto-container">
        <div class="producto-imagen">
            <img src="../image/Fender CD-60SCE.png" alt="Fender CD-60SCE">
        </div>
        <div class="producto-detalles">
            <div>
                <h1>Fender CD-60SCE</h1>
                <p class="descripcion">Guitarra acústica con 12 cuerdas</p>
                <p class="proveedor">Proveedor: Fender</p>
                <p class="categoria">Categoría: Guitarras Acústicas</p>
                <p class="precio">Q.3,150.00</p>
