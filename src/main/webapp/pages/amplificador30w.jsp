<%-- 
    Document   : amplificador30w
    Created on : 2 ago 2025, 21:58:20
    Author     : Marcos
--%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Amplificador 30W | Tienda en Línea</title>
    ...
    <body>
        ...
        <section class="producto-container">
            <div class="producto-imagen">
                <img src="../image/amplificador.jpg" alt="Amplificador 30W">
            </div>
            <div class="producto-detalles">
                <div>
                    <%
                        ProductoDAO productoDAO = new ProductoDAO();
                        Producto producto = productoDAO.getProductoById(16);
                        int stock = 0;
                        stock = producto.getStock();
                    %>
                    <h1>Amplificador 30W</h1>
                    <p class="descripcion">Compacto ideal para practicar</p>
                ...
                <form class="compra-form" action="${pageContext.request.contextPath}/ServletCarrito" method="post">
                    ...
                    <input type="hidden" name="idProducto" value="16">
