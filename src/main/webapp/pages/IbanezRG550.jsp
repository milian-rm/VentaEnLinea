<%-- 
    Document   : IbanezRG550
    Created on : 3/08/2025, 11:30:49
    Author     : Emilio
--%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Ibanez RG550 | Tienda en Línea</title>
    ...
    <body>
        ...
        <section class="producto-container">
            <div class="producto-imagen">
                <img src="../image/IbanezRG550.jpg" alt="Ibanez RG550">
            </div>
            <div class="producto-detalles">
                <div>
                    ...
                    %>
                    <h1>Ibanez RG550</h1>
                    <p class="descripcion">Guitarra eléctrica para shredding con trémolo flotante</p>
                    <p class="proveedor">Proveedor: Ibanez</p>
                    <p class="categoria">Categoría: Guitarras</p>
                    <p class="precio">Q. 5,200.00</p>
