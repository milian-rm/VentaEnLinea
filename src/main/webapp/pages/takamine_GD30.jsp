<%-- 
    Document   : takamine_GD30
    Created on : 3/08/2025, 12:27:13
    Author     : Kevin
--%>
...
<head>
    <meta charset="UTF-8">
    <title>Takamine GD30| Tienda en Línea</title>
...
<body>
    ...
    <section class="producto-container">
        <div class="producto-imagen">
            <img src="../image/takamine_GD30.jpg" alt="Guitarra Acustica Takamine GD30">
        </div>
        <div class="producto-detalles">
            <div>
                <h1>Guitarra Acustica Takamine GD30</h1>
                <p class="descripcion">Guitarra acústica dreadnought con tapa sólida de abeto</p>
