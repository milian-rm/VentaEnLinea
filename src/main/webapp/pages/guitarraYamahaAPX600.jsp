<%-- 
    Document   : guitarraYamahaAPX600
    Created on : 3/08/2025, 8:39:22 p. m.
...
<head>
    <meta charset="UTF-8">
    <title>Yamaha APX600 | Tienda en Línea</title>
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.3.7/dist/css/bootstrap.min.css" rel="stylesheet"
        integrity="sha384-LN+7fdVzj6u52u30Kp6M/trliBMCMKTyK833zpbD+pXdCLuTusPj697FH4R/5mcr" crossorigin="anonymous">
    <style>
        /* Aquí va el mismo CSS que en la vista de referencia */
        * {
...
<body>
    ...
    <section class="producto-container">
        <div class="producto-imagen">
            <img src="../image/Yamaha APX600.png" alt="Yamaha APX600">
        </div>
        <div class="producto-detalles">
            <div>
                <h1>Yamaha APX600</h1>
                <p class="descripcion">Guitarra electroacústica</p>
                <p class="proveedor">Proveedor: Yamaha</p>
                <p class="categoria">Categoría: Guitarras Electroacústicas</p>
                <p class="precio">Q.3,750.00</p>
                <p class="stock">Stock disponible: 10 unidades</p>
            </div>
