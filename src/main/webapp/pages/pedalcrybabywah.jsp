<%-- 
    Document   : pedalcrybabywah
    Created on : 2/08/2025, 22:56:53
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Pedal Cry Baby Wah | Tienda en Línea</title>
    ...
    <body>
        ...
        <section class="producto-container">
            <div class="producto-imagen">
                <img src="../image/crybeibi.jpg" alt="Pedal Cry Baby Wah">
            </div>
            <div class="producto-detalles">
                <div>
                    <%
                        ProductoDAO productoDAO = new ProductoDAO();
                        Producto producto = productoDAO.getProductoById(22);
                        int stock = 0;
                        stock = producto.getStock();
                    %>
                    <h1>Pedal Cry Baby Wah</h1>
                    <p class="descripcion">Pedal de expresión efecto wah</p>
                ...
                <form class="compra-form" action="${pageContext.request.contextPath}/ServletCarrito" method="post">
                    <input type="hidden" name="idProducto" value="22">
