...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Takamine EF341SC | Tienda en Línea</title>
    ...
    <body>
        ...
        <section class="producto-container">
            <div class="producto-imagen">
                <img src="../image/takamineEF341sc.jpg" alt="Takamine EF341SC">
            </div>
            <div class="producto-detalles">
                <div>
                    <%
                        ProductoDAO productoDAO = new ProductoDAO();
                        Producto producto = productoDAO.getProductoById(11);
                        int stock = 0;
                        stock = producto.getStock();
                    %>
                    <h1>Takamine EF341SC</h1>
                    <p class="descripcion">Electroacústica profesional con acabado negro brillante</p>
                    <p class="proveedor">Proveedor: Takamine</p>
                    <p class="categoria">Categoría: Electroacústicas</p>
                    <p class="precio">Q.4200.00 </p>
