<%-- 
    Document   : pedaldedistorsion
    Created on : 2/08/2025, 22:39:56
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Pedal de distorsión | Tienda en Línea</title>
    ...
    <body>
        ...
        <section class="producto-container">
            <div class="producto-imagen">
                <img src="../image/pedaldistorsion.jpg" alt="Pedal de distorsión">
            </div>
            <div class="producto-detalles">
                <div>
                    <%
                        ProductoDAO productoDAO = new ProductoDAO();
                        Producto producto = productoDAO.getProductoById(21);
                        int stock = 0;
                        stock = producto.getStock();
                    %>
                    <h1>Pedal de distorsión</h1>
                    <p class="descripcion">Clásico para guitarra eléctrica</p>
                ...
                <form class="compra-form" action="${pageContext.request.contextPath}/ServletCarrito" method="post">
                    <input type="hidden" name="idProducto" value="21">
