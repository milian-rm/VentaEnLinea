<%-- 
    Document   : Taylor214ce
    Created on : 4/08/2025, 9:26:32 a. m.
...
<head>
    <meta charset="UTF-8">
    <title>Taylor 214ce | Tienda en Línea</title>
...
<body>
    ...
    <section class="producto-container">
        <div class="producto-imagen">
            <img src="../image/Taylor 214ce.png" alt="Taylor 214ce">
        </div>
        <div class="producto-detalles">
            <div>
                <h1>Taylor 214ce</h1>
                <p class="descripcion">Guitarra electroacústica de gran sonido</p>
                <p class="proveedor">Proveedor: Taylor</p>
                <p class="categoria">Categoría: Guitarras Electroacústicas</p>
                <p class="precio">Q.12,500.00</p>
                <p class="stock">Stock disponible: 5 unidades</p>
            </div>
