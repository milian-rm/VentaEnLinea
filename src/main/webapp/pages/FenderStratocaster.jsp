<%-- 
    Document   : FenderTelecaster
    Created on : 3/08/2025, 11:30:21
    Author     : Emilio
--%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Fender Stratocaster | Tienda en Línea</title>
    ...
    <body>
        ...
        <section class="producto-container">
            <div class="producto-imagen">
                <img src="../image/FenderStratocaster.png" alt="Fender Stratocaster">
            </div>
            <div class="producto-detalles">
                <div>
                    <%
                        ProductoDAO productoDAO = new ProductoDAO();
                        Producto producto = productoDAO.getProductoById(6);
                        int stock = 0;
                        stock = producto.getStock();
                    %>
                    <h1>Fender Stratocaster</h1>
                    <p class="descripcion">Cuerpo de aliso y pastillas single coil</p>
