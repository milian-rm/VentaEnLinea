<%-- 
    Document   : ibanez_AW54
    Created on : 3/08/2025, 13:17:40
    Author     : Kevin
--%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Ibanez AW54 | Tienda en Línea</title>
    ...
    <body>
        ...
        <section class="producto-container">
            <div class="producto-imagen">
                <img src="../image/ibanez_AW54.jpg" alt="Guitarra acústica Ibanez AW54">
            </div>
            <div class="producto-detalles">
                <div>
                    <%
                        ProductoDAO productoDAO = new ProductoDAO();
                        Producto producto = productoDAO.getProductoById(2);
                        int stock = 0;
                        stock = producto.getStock();
                    %>
                    <h1>Ibanez AW54</h1>
                    <p class="descripcion">Guitarra acústica con acabado Open Pore Natural</p>
                    <p class="proveedor">Proveedor: Ibanez</p>
                    <p class="categoria">Categoría: Guitarras Acústicas</p>
                    <p class="precio">Q.2300.00</p>
