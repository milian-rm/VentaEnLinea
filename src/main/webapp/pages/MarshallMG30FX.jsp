<%-- 
    Document   : MarshallMG30FX
    Created on : 3 ago 2025, 8:53:50
    Author     : Marcos
--%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Marshall MG30FX | Tienda en Línea</title>
    ...
    <body>
        ...
        <section class="producto-container">
            <div class="producto-imagen">
                <img src="../image/Marshall MG30FX.jpg" alt="Marshall MG30FX">
            </div>
            <div class="producto-detalles">
                ...
                <form class="compra-form" action="${pageContext.request.contextPath}/ServletCarrito" method="post">
                    <input type="hidden" name="idProducto" value="20">
