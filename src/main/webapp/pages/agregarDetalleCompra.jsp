<%--
    ...
    Created on : 28 jul 2025, 18:53:17
    Author     : Marcos
--%>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Agregar Detalle de Compra - GuitarKinal</title>
    ...
    <body>
        ...
        <%-- Contenido Principal: Formulario de Agregar Detalle de Compra --%>
                ...
                <div class="col-md-6 col-lg-5">
                    ...
                    <form action="ServletDetalleCompra" method="post">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" id="idProducto" name="idProducto" class="form-control" min="1" required>
                        </div>
                        <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" id="precioUnitario" name="precioUnitario" class="form-control" step="0.01" min="0" required>
                        </div>

                        <%-- Botones de acción --%>
                        <div class="d-grid gap-2">
                            <button type="submit" class="btn btn-success btn-lg">Guardar Detalle</button>
                            <a href="<%= request.getContextPath() %>/pages/administracionDetalleCompra.jsp" class="btn btn-secondary btn-lg">Cancelar</a>
                        </div>
                    </form>
                </div>
            </div>
