        ...
        <main class="flex-grow-1"> 
            ...
            <div class="container-fluid mt-4">
                ...
                <div class="row justify-content-center"> 
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3"> 
                        <div class="card h-100"> 
                            <img src="image/Electroacustica.png" class="card-img-top" alt="Pedal de efectos"> 
                            <div class="card-body"> 
                                <h5 class="card-title">Guitarra Electroacústica</h5> 
                                <p class="card-text">Combina lo mejor del sonido acústico con la versatilidad de la amplificación.</p> 
                                <a href="pages/guitarrasElectroacusticas.jsp" class="btn btn-danger">Ver más</a> 
                            </div> 
                        </div> 
                    </div> 
                </div> 
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3"> 
                        <div class="card h-100"> 
                            ...
                            <div class="card-body"> 
                                ...
                                <a href="pages/amplificadores.jsp" class="btn btn-danger">Ver más</a> 
                            </div> 
                        </div> 
                    </div> 
                    ...
                    <div class="col-12 col-sm-6 col-md-4 col-lg-3"> 
                        <div class="card h-100"> 
                            ...
                            <div class="card-body"> 
                                ...
                                <p class="card-text">Complementa tu experiencia musical con los accesorios ideales para tu instrumento.</p> 
                                <a href="pages/accesorios.jsp" class="btn btn-danger">Ver más</a> 
                            </div> 
                        </div> 
                    </div> 
                </div> 
